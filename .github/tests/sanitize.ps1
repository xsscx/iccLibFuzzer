...
##                 https://color.org
#
## Intent: PowerShell sanitization functions for GitHub Actions output
#
## Last Updated: 16-DEC-2025
##               Updated to match bash version functionality
#
## Comment: Provides sanitization for user-controllable values in CI/CD
#
###############################################################
