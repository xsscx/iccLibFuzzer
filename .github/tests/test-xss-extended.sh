...
#                 https://color.org
#
# Intent: Extended sanitizer tests for additional attack vectors
#         Tests SVG injections, encoding bypasses, and shell injections
#
...
#   - Various encodings of < character (fuzzing)
#   - Bash/shell injection signatures
#
###############################################################
