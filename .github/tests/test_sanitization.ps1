...
##                 https://color.org
#
## Intent: Test script for sanitization functions in sanitize.ps1
##
## Last Updated: 16-DEC-2025
##               Initial implementation
#
## Comment: Tests HTML entity escaping, Unicode handling, and security edge cases
##          Run: pwsh .github/scripts/test_sanitization.ps1
#
###############################################################
