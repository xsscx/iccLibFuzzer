...
##                 https://color.org
#
# Last Modified: 27-NOV-2025 1700Z by David Hoyt
# Intent: Demonstrate a Fix for Open Issue(s)
#         Unix Issue IccProfLib/IccTagBasic.cpp:6628:41: 
#         runtime error: nan is outside the range...
# 
...
#                      - Include the Output
# *** All Reports must include a known good & working reproduction & Fix ***
# gh issue list --repo InternationalColorConsortium/iccDEV
# PoC for Issues: 232, 233, 234, 235, 236, 237, 238, 239, 240
#
#  URL https://github.com/InternationalColorConsortium/iccDEV
#
# Run: /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/InternationalColorConsortium/iccDEV/refs/heads/research/contrib/HelperScripts/ub-nan-outside-range-IccTagBasic-Line6628.sh)"
#
#
###############################################################
...
echo ""
echo "===================== iccDEV | Unix Issue Fix Template ====================="
echo ""
echo "Fix for a NaN Bug..."
echo "IccProfLib/IccTagBasic.cpp:6628:41" 
echo "runtime error: nan is outside the range..."
echo ""
...
set +e
echo ""
echo "Start IccProfLib/IccTagBasic.cpp:6628:41: runtime error: nan is outside the range..."
cd CMYK-3DLUTs
...
# Treat 255 as success for PR-author validation
if [ "$rp_rc" -eq 255 ]; then
    adj_rc=0
else
    adj_rc="$rp_rc"
fi

status "Reproduction Block" "$adj_rc"
