...
# Intent: Ubuntu short form Build Report
#
#
#
#
...
#
#
# Run: /usr/bin/env zsh <(curl -fsSL https://raw.githubusercontent.com/InternationalColorConsortium/iccDEV/refs/heads/research/contrib/HelperScripts/build-report.zsh)
#
#
#
#
...
log_file="unix_inventory_$(date +%Y%m%d_%H%M%S).log"
HTML_FILE="unix_build_report.html"
...
while read -r binary; do
    [[ -z "$binary" ]] && continue
    [[ ! -r "$binary" ]] && log_message " Skipping unreadable file: $binary" && continue
...
<body>
<h1>iccDEV | Unix Developer Report</h1>
