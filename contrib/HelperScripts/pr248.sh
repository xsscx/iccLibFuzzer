...
#
#
# Run: /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/InternationalColorConsortium/iccDEV/refs/heads/research/contrib/HelperScripts/pr248.sh)"
#
#
###############################################################
...
echo ""
           set +e
           echo "========= Start undefined-behavior Test ... PR248 ========="
...
echo ""
           ...
           cd ..
           set -e
           echo "========= Stop undefined-behavior Test ... PR248 =========="
echo ""
echo "======================================================"
echo "===================  ISSUE STOP   ===================="
echo "======================================================"
