...
#
#
# Run: /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/InternationalColorConsortium/iccDEV/refs/heads/research/contrib/HelperScripts/issue243.sh)"
#
#
###############################################################
...
echo ""
            ...
            iccFromXml sRGB_D65_colorimetric_61477.xml out.icc
            cd ..
            set -e
            echo "========= Stop Leaking... =========="
echo ""
